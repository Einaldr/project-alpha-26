...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.icons.driver' => 'string',
            'filesystems.disks.icons.root' => 'string',
            'filesystems.disks.icons.url' => 'string',
            'filesystems.disks.icons.visibility' => 'string',
            'filesystems.disks.icons.throw' => 'boolean',
            'filesystems.disks.icons.report' => 'boolean',
            ...
            'filesystems.disks.images.report' => 'boolean',
            'filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/storage' => 'string',
            'filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/icons' => 'string',
            'filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/images' => 'string',
            ...
            'mail.mailtrap.api-key' => 'NULL',
            'mail.test.testing-mail' => 'NULL',
            ...
            'settings.tos_version' => 'string',
            'settings.privacy_version' => 'string',
            'settings.frontend_url' => 'NULL',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.icons.driver','filesystems.disks.icons.root',
'filesystems.disks.icons.url','filesystems.disks.icons.visibility','filesystems.disks.icons.throw','filesystems.disks.icons.report','filesystems.disks.images.driver',
'filesystems.disks.images.root','filesystems.disks.images.url','filesystems.disks.images.visibility','filesystems.disks.images.throw','filesystems.disks.images.report',
'filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/storage','filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/icons','filesystems.links./home/einaldr/Repositories/project_alpha/backend/public/assets/images','logging.default','logging.deprecations.channel',
...
'mail.markdown.paths','mail.markdown.extensions','mail.mailtrap.api-key','mail.test.testing-mail','queue.default',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','services.mailtrap-sdk.host','services.mailtrap-sdk.apiKey',
'services.mailtrap-sdk.inboxId','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'session.secure','session.http_only','session.same_site','session.partitioned','settings.tos_version',
'settings.privacy_version','settings.frontend_url','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TOS_VERSION',);
